...
export default function HytalePremiumHosting() {
  ...
  return (
    <HostingPageLayout
      badge={{ icon: <Gamepad2 className="w-8 h-8 text-primary" />, label: "Hytale Premium Hosting" }}
      title="HYTALE PREMIUM"
      titleHighlight="SERVER HOSTING"
      description="Premium Hytale server hosting with KineticHost! Maximum performance with priority support, premium hardware, and unlimited resources!"
