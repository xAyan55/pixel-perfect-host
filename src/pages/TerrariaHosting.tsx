...
const trustBadges = [
  ...
  { icon: <Package className="w-4 h-4 text-primary" />, label: "TShock Pre-installed" },
...
export default function TerrariaHosting() {
  ...
  return (
    <HostingPageLayout
      badge={{ icon: <Gamepad2 className="w-8 h-8 text-primary" />, label: "Terraria Server Hosting" }}
      title="TERRARIA"
      titleHighlight="SERVER HOSTING"
      description="Host your Terraria server with KineticHost. TShock pre-installed, multiplayer ready with instant setup and 24/7 customer support!"
      descriptionHighlight="TShock pre-installed, multiplayer ready"
