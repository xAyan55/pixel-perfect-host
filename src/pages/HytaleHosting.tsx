...
const trustBadges = [
  ...
  { icon: <Package className="w-4 h-4 text-primary" />, label: "One-Click Mod Installer" },
...
export default function HytaleHosting() {
  ...
  return (
    <HostingPageLayout
      ...
      description="Get ready for Hytale with KineticHost! Experience lightning-fast, reliable servers designed for the next generation of block-based adventures with friends!"
      descriptionHighlight="lightning-fast, reliable servers"
