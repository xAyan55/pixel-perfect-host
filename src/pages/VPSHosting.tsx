...
import { Cloud, Loader2, Shield, Zap, Server, Lock } from "lucide-react";
...
export default function VPSHosting() {
  ...
  const features = [
    { icon: <Server className="w-6 h-6" />, title: "Full Root Access", desc: "Complete control over your server" },
    { icon: <Zap className="w-6 h-6" />, title: "NVMe Storage", desc: "Ultra-fast SSD performance" },
    { icon: <Shield className="w-6 h-6" />, title: "DDoS Protection", desc: "Always-on attack mitigation" },
    { icon: <Lock className="w-6 h-6" />, title: "99.99% Uptime", desc: "Enterprise reliability guaranteed" },
  ];
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Choose Your VPS Plan</h2>
