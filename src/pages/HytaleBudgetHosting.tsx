...
export default function HytaleBudgetHosting() {
  ...
  return (
    <HostingPageLayout
      badge={{ icon: <Gamepad2 className="w-8 h-8 text-primary" />, label: "Hytale Budget Hosting" }}
      title="HYTALE BUDGET"
      titleHighlight="SERVER HOSTING"
      description="Affordable Hytale server hosting with KineticHost! Get started with budget-friendly plans perfect for small groups and casual play!"
