...
export default function MinecraftHosting() {
  ...
  return (
    <HostingPageLayout
      badge={{ icon: <Gamepad2 className="w-8 h-8 text-primary" />, label: "Minecraft Server Hosting" }}
      title="MINECRAFT"
      titleHighlight="SERVER HOSTING"
      description="Host your Minecraft server with KineticHost. Perfect for modded servers, plugins, and multiplayer gaming with full customization and instant setup!"
      descriptionHighlight="modded servers, plugins, and multiplayer gaming"
