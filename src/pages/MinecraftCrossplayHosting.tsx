...
import { Gamepad2, Shield, Zap, Cloud, Headphones, Users, ShieldCheck } from "lucide-react";
...
const trustBadges = [
  ...
  { icon: <Users className="w-4 h-4 text-primary" />, label: "Java & Bedrock Together" },
  { icon: <Shield className="w-4 h-4 text-primary" />, label: "DDoS Protection" },
];

export default function MinecraftCrossplayHosting() {
  ...
  return (
    <HostingPageLayout
      badge={{ icon: <Gamepad2 className="w-8 h-8 text-primary" />, label: "Minecraft Crossplay" }}
      title="MINECRAFT CROSSPLAY"
      titleHighlight="SERVER HOSTING"
      description="Unite Java and Bedrock players on one server with KineticHost! Play together regardless of platform with our Geyser-powered crossplay hosting!"
      descriptionHighlight="Java and Bedrock players on one server"
