...
export default function MinecraftJavaHosting() {
  ...
  return (
    <HostingPageLayout
      badge={{ icon: <Gamepad2 className="w-8 h-8 text-primary" />, label: "Minecraft Java Edition" }}
      title="MINECRAFT JAVA"
      titleHighlight="SERVER HOSTING"
      description="Host your Minecraft Java Edition server with KineticHost. Perfect for modded servers, plugins, and the classic Java experience with full customization!"
      descriptionHighlight="modded servers, plugins, and the classic Java experience"
