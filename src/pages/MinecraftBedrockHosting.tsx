...
import { Gamepad2, Shield, Zap, Cloud, Headphones, Smartphone, ShieldCheck } from "lucide-react";
...
const trustBadges = [
  ...
  { icon: <Smartphone className="w-4 h-4 text-primary" />, label: "Mobile & Console Support" },
  { icon: <Shield className="w-4 h-4 text-primary" />, label: "DDoS Protection" },
];

export default function MinecraftBedrockHosting() {
  ...
  return (
    <HostingPageLayout
      badge={{ icon: <Gamepad2 className="w-8 h-8 text-primary" />, label: "Minecraft Bedrock Edition" }}
      title="MINECRAFT BEDROCK"
      titleHighlight="SERVER HOSTING"
      description="Host your Minecraft Bedrock Edition server with KineticHost. Perfect for mobile, console, and Windows 10 players with cross-platform support!"
      descriptionHighlight="mobile, console, and Windows 10 players"
