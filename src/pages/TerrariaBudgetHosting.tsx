...
import { Gamepad2, Shield, Zap, Cloud, Headphones, Wallet, ShieldCheck } from "lucide-react";
...
const trustBadges = [
  ...
  { icon: <Wallet className="w-4 h-4 text-primary" />, label: "Budget Friendly" },
  { icon: <Shield className="w-4 h-4 text-primary" />, label: "DDoS Protection" },
];

export default function TerrariaBudgetHosting() {
  ...
  return (
    <HostingPageLayout
      badge={{ icon: <Gamepad2 className="w-8 h-8 text-primary" />, label: "Terraria Budget Hosting" }}
      title="TERRARIA BUDGET"
      titleHighlight="SERVER HOSTING"
      description="Affordable Terraria server hosting with KineticHost! Get started with budget-friendly plans perfect for small groups and casual exploration!"
      descriptionHighlight="budget-friendly plans"
